      ...
      <div className="home" id="home">
        <div className="descCont hidden left">
          ...
          <div className="desc">
            ...
            faucibus, dictum massa sit amet, condimentum nibh. Ut quis quam
            erat. Sed ornare bibendum nulla sit amet scelerisque. Mauris
            volutpat neque non varius ultricies. Nulla efficitur lacinia justo,
            vitae gravida justo lacinia non. Aenean nec justo quis mauris
            tincidunt mattis id non sapien.Lorem ipsum dolor sit amet,
